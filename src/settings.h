...
#ifndef WAVESHARE_S3_TOUCH_LCD_1_9_PICO_AUDIO
...
#define LIST_TIMER           5        // After this time (seconds), the display returns from the list view
...
#ifdef WAVESHARE_S3_TOUCH_LCD_1_9_PICO_AUDIO
    #undef TFT_CONTROLLER
    #define TFT_CONTROLLER 11 // ST7789V2, Waveshare ESP32-S3-Touch-LCD-1.9 TFT, 320x170 landscape
    #undef DISPLAY_INVERSION
    #define DISPLAY_INVERSION 1 // factory init sequence sends INVON (0x21) — keep state consistent
    #undef TFT_ROTATION
    #define TFT_ROTATION 0 // landscape done in hardware via MADCTL_MV (like ILI9341); no soft rotation
    #undef TFT_FREQUENCY
    #define TFT_FREQUENCY 40000000
    #undef BRIGHTNESS_INVERSION
    #define BRIGHTNESS_INVERSION 1 // backlight on GPIO14 is ACTIVE-LOW (Waveshare factory example drives BL LOW to turn on)
    #undef TP_CONTROLLER
    #define TP_CONTROLLER 9 // CST816
    #undef TP_ROTATION
    #define TP_ROTATION 1
    #undef TP_H_MIRROR
    #define TP_H_MIRROR 0
    #undef TP_V_MIRROR
    #define TP_V_MIRROR 0
    #undef SDMMC_FREQUENCY
    #define SDMMC_FREQUENCY 40000000
    ...
    #define TFT_MISO -1
    #define TFT_SCK 10
    #define TFT_COL_OFFSET 0  // landscape (MADCTL_MV): the 35px panel offset moves to the row axis
    #define TFT_ROW_OFFSET 35 // portrait would be (35,0); landscape is (0,35)
