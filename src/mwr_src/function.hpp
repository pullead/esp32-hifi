...
const char ir_buttons_json[] = "[{\"A\":\"0x00\",\"label\":\"IR address\"},"
                               ...
                               "{\"19\":\"-1\",\"label\":\"-\"}]";
// ——————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————
const char stations_json[] = "[[\"*\",\"US\",\"SomaFM Groove Salad\",\"http://ice1.somafm.com/groovesalad-128-mp3\"],"
                             "[\"*\",\"JP\",\"Stereo Anime\",\"https://radio.stereoanime.com/listen/stereoanime/128\"],"
                             "[\"*\",\"JP\",\"Big B Radio Jpop\",\"https://antares.dribbcast.com/proxy/jpop?mp=/s\"],"
                             "[\"*\",\"JP\",\"Shonan Beach FM\",\"http://shonanbeachfm.out.airtime.pro:8000/shonanbeachfm_a\"],"
                             "[\"*\",\"JP\",\"Jazz Sakura\",\"http://kathy.torontocast.com:3330/stream/1/?esPlayer&cb=82181.mp3\"],"
                             "[\"*\",\"JP\",\"J-Rock Powerplay\",\"https://kathy.torontocast.com:3340/;?shoutcast\"],"
                             "[\"*\",\"US\",\"SomaFM Drone Zone\",\"http://ice1.somafm.com/dronezone-128-mp3\"],"
                             "[\"*\",\"US\",\"SomaFM Secret Agent\",\"http://ice1.somafm.com/secretagent-128-mp3\"],"
                             "[\"*\",\"US\",\"SomaFM Beat Blender\",\"http://ice1.somafm.com/beatblender-128-mp3\"],"
                             "[\"*\",\"US\",\"SomaFM Lush\",\"http://ice1.somafm.com/lush-128-mp3\"],"
                             "[\"*\",\"US\",\"SomaFM Indie Pop Rocks\",\"http://ice1.somafm.com/indiepop-128-mp3\"],"
                             "[\"*\",\"US\",\"SomaFM Illinois Street Lounge\",\"http://ice1.somafm.com/illstreet-128-mp3\"]]";
// ——————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————
