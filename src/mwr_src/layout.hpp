...
constexpr uint16_t h_res = 320, v_res = 170; // native SH8601 visible area
constexpr uint16_t h_footer = 18;
#else
...
inline constexpr DisplayConfig config = {
    ...
    v_res == 170 ? 112 : 156, // bigNumbersFontSize
    15,                  // fileNumberFontSize
    {5, 77, 129, 57, 0}, // sleeptimeXPos[5]
    v_res == 170 ? 34 : 48, // sleeptimeYPos
    320,                 // width
    v_res,               // height
    5,                   // brightnessMin
    255,                 // brightnessMax
