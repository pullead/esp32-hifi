...
#if TFT_CONTROLLER == 6
    #define TFT_MODE_SPI
    // The compact widget implementations are shared with the 320px-wide
    // display; layout.hpp supplies this board's 170px-high geometry.
    #define TFT_LAYOUT_S
    #define TFT_LAYOUT_WAVESHARE_19
#endif
...
// Waveshare routes the SH8601 panel to ESP32-S3 SPI3_HOST (Arduino HSPI).
// Using FSPI/SPI2 lights the backlight but leaves the panel without LCD data.
